                    ...
                    <div>
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <div className="w-7 h-7 rounded-full border-2 border-red-700 text-red-700 flex items-center justify-center text-sm font-extrabold mt-0.5 flex-shrink-0">
                            1
                          </div>
                          <div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h4 className="font-semibold">보조 바퀴</h4>
                            <p className="text-sm text-gray-600">
                              차량 안정성 보조
                            </p>
                          </div>
