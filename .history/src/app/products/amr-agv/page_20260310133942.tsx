...
import {
    AlertCircle, Battery, BookOpen, CheckCircle, ChevronRight, ClipboardList, Clock, Forklift,
    MapPin, Navigation, Package, Ruler, Settings, Shield, ShoppingCart, Wifi, Wrench
} from 'lucide-react';
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  LiDAR SLAM 기술로 정확한 위치 파악 및 자동 이동
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6 mb-12">
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-3xl font-bold text-gray-600">1.5톤</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-3xl font-bold text-gray-600">4.3km/h</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-3xl font-bold text-gray-600">4,500mm</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-2xl font-bold text-gray-600">48V 300Ah</p>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-gray-600 rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <h4 className="font-semibold">조향/경고 표시등</h4>
                        <p className="text-sm text-gray-600">
                          작업 상태 및 방향 표시
                        </p>
                      </div>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-gray-600 rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <h4 className="font-semibold">포크틸 센서 (좌/우)</h4>
                        <p className="text-sm text-gray-600">
                          포크 기울기 감지
                        </p>
                      </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-gray-600 rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <h4 className="font-semibold">주체어 장치 박스</h4>
                        <p className="text-sm text-gray-600">
                          전체 시스템 제어
                        </p>
                      </div>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-gray-600 rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <h4 className="font-semibold">후방 안전 센서 (음성)</h4>
                        <p className="text-sm text-gray-600">
                          후방 장애물 감지 및 경고
                        </p>
                      </div>
              ...
              <div className="aspect-square bg-gray-100 rounded-lg flex items-center justify-center relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-80 h-80">
                    ...
                    {/* Middle zone - 1m */}
                    <div className="absolute inset-8 border-4 border-gray-300 rounded-full"></div>
                    {/* Inner zone - 0.2m */}
                    <div className="absolute inset-16 border-4 border-gray-300 rounded-full"></div>
                  </div>
                </div>
