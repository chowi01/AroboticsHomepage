        ...
        <div className="container-classic">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              보유 중인 인증서를 PDF 썸네일 형태로 확인할 수 있습니다
            </p>
          </div>
              ...
              {certifications.map((cert, index) => (
                ...
                >
                  <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-all duration-300">
                    <div className="relative w-full h-[300px] md:h-[320px] bg-gray-100 overflow-hidden">
                      <iframe
                    ...
                    <div className="px-4 py-3 min-h-[72px] flex items-center justify-center">
