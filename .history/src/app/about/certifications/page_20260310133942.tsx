import { Award, Badge, Lightbulb, Shield } from 'lucide-react';
...
const certifications = [
  ...
  },
  {
    ...
    title: "기업부설연구소",
    subtitle: "R&D 전문 연구소",
    description: "지속적인 연구개발을 통해 기술 혁신을 선도하는 연구소입니다",
    date: "2022.07 설립",
  },
];
...
const patents = [
  ...
  {
    number: "10-2025-0036012",
    title: "자율 이동 로봇 제어 시스템 및 제어방법",
    status: "출원",
  },
  {
    number: "10-2025-002011",
    title: "자율 이동 로봇의 정지 정확도 향상 장치",
    status: "출원",
  },
];
              ...
              return (
                <div key={index} className="card-classic group">
                  <div className="flex items-start">
                    <div className="icon-container-classic flex-shrink-0 mr-6">
