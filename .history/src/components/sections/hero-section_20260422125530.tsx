        ...
        <div className="container-classic w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <h1 className="text-2xl md:text-4xl lg:text-3xl font-bold text-white mb-6 leading-tight">
                {/* <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight"></h1> */}
